...

{
    ...
    if (valortotal > 200)
    {
        double valorcomdesconto = valortotal * 0.9; // aplica 10 de desconto
        Console.WriteLine("desconto de 10% aplicado!");
        Console.WriteLine($"valor final da compra: R$ {valorcomdesconto}");
    }
    else
    {
        Console.WriteLine("adicione mais itens ao carinho para ganha desconto de 10%.");
        Console.WriteLine("valor atual da compra: R$ {valortotalF2");
